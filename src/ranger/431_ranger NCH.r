...
param <- list(
  ...
  "mtry" = 41,
  "min.node.size" = 465, # tamaño minimo de las hojas
...
# elimino las variables que me hacen ruido con valores null
...
archivo_salida <- "./exp/KA4310/KA4310_001_convaloresRANGERBO_v1.csv"
