...
PARAM <- list()
PARAM$semilla <- c(300007,600073,100069,750083,750029)
...
setwd("home\\nicolasch6\\") # Establezco el Working Directory
...
for (semilla in PARAM$semilla) {
  
  particionar(dataset, division = c(7, 3), 
    agrupa = "clase_ternaria", seed = semilla) # aqui se usa SU semilla
