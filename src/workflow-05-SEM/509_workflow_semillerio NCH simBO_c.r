...
DT_incorporar_dataset_baseline <- function( pmyexp, parch, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z511_DT_incorporar_dataset.r"
...
CA_catastrophe_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z521_CA_reparar_dataset.r"
...
DR_drifting_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z531_DR_corregir_drifting.r"
...
FE_historia_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z541_FE_historia.r"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z551_TS_training_strategy.r"
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z561_HT_lightgbm.r"
  ...
  param_local$lgb_param <- list(
    ...
    feature_fraction = c( 0.5, 0.501 ),
    num_leaves = c( 505L, 506L,  "integer" ),
    min_data_in_leaf = c( 1307L, 1308L, "integer" )
  )
...
ZZ_final_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z571_ZZ_final.r"
...
ZZ_final_semillerio_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-05-SEM/z881_ZZ_final_semillerio.r"
